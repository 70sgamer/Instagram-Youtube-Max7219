// Instagram & Youtube subscribers counter
// Credit to Roberto Delgado who wrote most of the code. 
...
#define API_KEY "youryoutubeapikey" //Your Youtube API-Key 
#define CHANNEL_ID "yourchannelid" // Your youtube channel ID. 

String userName = "yourinstagram"; // Your Instagram Username
...
const char* ssid     = "yourwifissdi";      // SSID of local network
